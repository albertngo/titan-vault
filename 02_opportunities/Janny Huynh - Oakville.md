...
- 2026-09-06 — Notion daily ingest `work_order_deficiency` (WO-Janny Huynh-090526): new deficiency work order created, contractor notified 2026-09-05 — door stoppers reinstalled, several holes needing repair, $4,145 to collect, status "Notified Contractor." The $4,145 figure exactly matches this opportunity's total won value — likely a linked-value display quirk; confirm the real deficiency amount in Notion. See [[Janny Huynh]] Log.
- 2026-09-10 — Notion daily ingest `work_order_deficiency` (WO-Janny Huynh-090526): status moved to **completed** (completed 2026-09-08). See [[Janny Huynh]] Log for full detail.
