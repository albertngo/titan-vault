...
- 2026-09-26 — GHL daily ingest, `By source` detail + drift `meeting_no_followup` (high, 340% of the 30-day threshold): 101.9 days in Meeting (Scheduled), still no `stale_lead` tag, still the largest single open opportunity in the account ($41,150) — named today as the worst case in the brief's wider 24-of-25 meeting-scheduled follow-up finding. See [[Maria Wildfang]] Log.
