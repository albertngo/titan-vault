...
ghl_opportunity_id: 52we6fC8KrTgEMEYoyLI
...
**Client:** [[Ricardo Mendoza]]
**Scope:** Stairs + basement flooring, Mississauga
**Value:** $9,250 CAD (won 2026-08-10)
...
- 2026-08-14 — Deposit-schedule follow-up text sent; reply came back as an empty-body SMS (likely a payment screenshot) unreadable via this ingest pull — check GHL directly to confirm the deposit. Notion's Master Payments Log separately recorded a $1,878.63 e-transfer received 2026-08-13 (ref `C1ABnrRU7baD`), not linked to a project row on that end — may or may not be this deposit; unreconciled.
